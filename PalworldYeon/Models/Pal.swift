...
//        palskill = PalSkill(skillName: skillName, description: description)
//
//        
...
//        // Skill 관련 필드 인코딩
////        try container.encode(PalSkill.skillName, forKey: .skillName)
////        try container.encode(PalSkill.description, forKey: .description)
//    }
//}
//
//// MARK: - Element
...
//
//// MARK: - Skill
//struct PalSkill: Codable {
//    var skillName: String
//    var description: String
//}
//
//extension Pal {
//    init(id: Int, image: String?, name: String, palDeckNo: String, element1: Element, element2: Element?, workAptitudes: WorkAptitude, otherInfo: OtherInfo, palskill: PalSkill) {
//        self.id = id
//        self.image = image
//        self.name = name
